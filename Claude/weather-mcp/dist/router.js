...
const geoCache = new TTLCache(60 * 60 * 1000); // 1 hour
const currCache = new TTLCache(10 * 60 * 1000); // 10 minutes
const fcstCache = new TTLCache(30 * 60 * 1000); // 30 minutes
...
export async function fetchAllSources(city) {
    const geo = await resolveLocation(city);
